...
from .contentOfContainer.content import NFLMainContent, NFLTeamsContent, NFLRosterContent, NFLScheduleContent
...
class NFLMainPageUI:
    ...
    def show_main_content(self, e):
        self.content_container.content = NFLMainContent(self.page)
        self.content_container.update()

    def show_teams_content(self, e):
        self.content_container.content = NFLTeamsContent(self.page)
        self.content_container.update()

    def show_roster_content(self, e):
        self.content_container.content = NFLRosterContent(self.page)
        self.content_container.update()

    def show_schedule_content(self, e):
        self.content_container.content = NFLScheduleContent(self.page)
        self.content_container.update()
