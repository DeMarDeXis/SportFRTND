...
nhl_img = "https://avatars.mds.yandex.net/i?id=5c2a7c401dd26e886cfa61e004627cac_l-5105971-images-thumbs&n=13"
...
class WelcomePageUI:
    ...
    def create_middle_panel(self, page: ft.Page) -> ft.Container:
        return ft.Container(
            ...
            content=ft.Row(
                controls=[
                    AnimatedCard("MLB", "", "GO to Baseball, bro", mlb_img, page, '/mainMLB').build(),
                    AnimatedCard("NBA", "", "AAAAND ONE", nba_img, page, '/mainNBA').build(),
                    AnimatedCard("NFL", "", "Eeexit light!!!",nfl_img, page, '/mainNFL').build(),
                    AnimatedCard("NHL", "", "Where's my teeth?", nhl_img, page, '/mainNHL').build()
                ],
            )
        )
