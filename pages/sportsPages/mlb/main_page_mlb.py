...
from .contentOfContainer.content import MLBMainContent, MLBTeamsContent, MLBRosterContent, MLBScheduleContent

get_team = HOST + "/app/mlb/teams"
...
class MLBMainPageUI:
    ...
    def show_main_content(self, e):
        self.content_container.content = MLBMainContent(self.page)
        self.content_container.update()

    def show_teams_content(self, e):
        self.content_container.content = MLBTeamsContent(self.page)
        self.content_container.update()

    def show_roster_content(self, e):
        self.content_container.content = MLBRosterContent(self.page)
        self.content_container.update()

    def show_schedule_content(self, e):
        self.content_container.content = MLBScheduleContent(self.page)
        self.content_container.update()
