...
get_mlb_team = HOST + "/app/mlb/teams"

class MLBMainContent(ft.Column):
        ...
        self.img_container = ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Text("MLB Dashboard", size=24, weight=ft.FontWeight.BOLD),
...
class MLBTeamsContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        ...
        self.controls = [
            ft.Text("MLB Teams", size=24, color=defaultFontColor, weight=ft.FontWeight.BOLD),
            ft.ProgressRing(),
        ]
    ...
    def load_data(self):
        try:
            ...
            response = requests.get(get_mlb_team, headers=headers)
...
class MLBRosterContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        self.scroll = ft.ScrollMode.AUTO
...
class MLBScheduleContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        self.scroll = ft.ScrollMode.AUTO
        ...
        self.full_text = "Расписание MLB - в разработке..."
        self.displayed_text = ""
        self.text_index = 0
