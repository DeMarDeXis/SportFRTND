...
get_nba_team = HOST + "/app/nba/teams"

class NBAMainContent(ft.Column):
        ...
        self.img_container = ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.Text("NBA Dashboard", size=24, weight=ft.FontWeight.BOLD),
...
class NBATeamsContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        ...
        self.controls = [
            ft.Text("NBA Teams", size=24, color=defaultFontColor, weight=ft.FontWeight.BOLD),
            ft.ProgressRing(),
        ]
    ...
    def load_data(self):
        try:
            ...
            response = requests.get(get_nba_team, headers=headers)
...
class NBARosterContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        self.scroll = ft.ScrollMode.AUTO
...
class NBAScheduleContent(ft.Column):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.page = page
        self.scroll = ft.ScrollMode.AUTO
        ...
        self.full_text = "Расписание NBA - в разработке..."
        self.displayed_text = ""
        self.text_index = 0
